...
namespace Diploma.BLL.Tests
{
    ...
    public class PasswordHasherTests
    {
        ...
        {
            Assert.Throws<FormatException>(() => _passwordHasher.VerifyPasswordHash(password, passwordHash));
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => _passwordHasher.VerifyPasswordHash(password, passwordHash));
        }
